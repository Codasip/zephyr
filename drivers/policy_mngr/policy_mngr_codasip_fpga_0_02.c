...
//    if ( alarm_id >= POLICY_MANAGER_ALARMS )
...
static const struct policy_mngr_driver_api policy_mngr_codasip_driver_api = {
    .setup           = policy_mngr_codasip_setup,
    .set_alarm       = policy_mngr_codasip_set_alarm
};
...
#define CODASIP_POLICY_MNGR_INIT( index )                                            \
    ...
    DEVICE_DT_INST_DEFINE( index,                                                    \
                &policy_mngr_codasip_init, NULL,                                     \
                &policy_mngr_codasip_data_##index,                                   \
                &policy_mngr_codasip_cfg_##index, POST_KERNEL,                       \
