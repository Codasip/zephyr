...
./make-sample.sh codasip_hobgoblin_l110eagle     samples/codasip          blinkers
./make-sample.sh codasip_hobgoblin_l110eagle     samples/subsys/console   getchar
./make-sample.sh codasip_hobgoblin_l110eagle     samples                  synchronization
./make-sample.sh codasip_hobgoblin_l110eagle     samples                  philosophers
./make-sample.sh codasip_hobgoblin_l110eagle     samples/drivers/uart     echo_bot               echo_bot-rx_interrupt
#./make-sample.sh codasip_hobgoblin_l110eagle     samples/codasip          hello_world_user      CURRENTLY NO PMP ON L110 SO THIS DOES NOT WORK
./make-sample.sh codasip_hobgoblin_l110eagle     samples/codasip          fat_fs
